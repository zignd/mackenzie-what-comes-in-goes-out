...
class GameScene:
    def __init__(self, win):
        ...
        self.components = [self.satiety_gauge, self.hygiene_gauge, self.toilet_gauge]
    ...
    while 1:
        ...
        for event in events:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                print("debug: current mouse cursor position", pygame.mouse.get_pos())
